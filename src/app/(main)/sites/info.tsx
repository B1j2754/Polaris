...
const PILL_INPUT =
    "font-sansation h-14 rounded-full border border-line px-5 text-lg leading-tight text-fg";

const GUIDE: { image: number; caption: string }[] = [
    { image: require('@/assets/images/hand-demo-spread.jpg'), caption: 'A hand, spread out at arm\'s length ≈ 25°.' },
    { image: require('@/assets/images/hand-demo-fist.jpg'), caption: 'A fist at arm\'s length ≈ 10°.' },
    { image: require('@/assets/images/hand-demo-three.jpg'), caption: 'Three fingers, spread out at arm\'s length ≈ 5°.' },
    { image: require('@/assets/images/hand-demo-finger.jpg'), caption: 'A finger at arm\'s length ≈ 1°.' },
];
...
export default function SiteInfo() {
    ...
    return (
        <View className="flex-1 bg-black">
            ...
            >
                <Text className="font-sansation text-4xl text-fg tracking-[1px]">
    ...
    return (
        <Modal visible={open} transparent animationType="slide" onRequestClose={onClose}>
            ...
            <View className="rounded-t-3xl border-t border-line bg-sheet pb-12 pt-5">
                ...
                <Pressable onPress={onClose} className="self-end flex-row items-center gap-2 rounded-full border border-fg/20 bg-surface px-3 py-1.5 active:opacity-60 mr-5 mt-5">
