          ...
          <>
            ...
            <View className="gap-2">
              <View className="flex-row items-center gap-2">
                <Text className="font-sansation text-lg text-fg-muted tracking-[1px]">How much sky is blocked?</Text>
              ...
              <Text className="font-sansation text-sm text-fg-dim tracking-[1px]">
                Trees, buildings and hills eat the bottom {draft.horizonDeg}° of your sky. Nothing below that counts as
                up.
              </Text>
            </View>
            ...
            <View className="items-center gap-3 pt-2">
              ...
              {id && (
                ...
                >
                  ...
                  <Text className="font-sansation text-lg leading-tight text-danger tracking-[1px]">Delete site</Text>
                </Pressable>
              )}
            </View>
          </>
        ...
        >
          {GUIDE.map(({ image, caption }, i) => (
            <View key={i} style={{ width }} className="items-center gap-3 px-6">
              ...
              <Text className="font-sansation text-center text-base text-fg-muted tracking-[1px]">{caption}</Text>
            </View>
          ))}
        </ScrollView>
