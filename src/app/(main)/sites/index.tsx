    ...
    <SafeAreaView className="flex-1 bg-black" edges={["top"]}>
      ...
      >
        ...
        <Text className="font-sansation text-base text-fg-muted tracking-[1px]">
          Everything the app calculates, from sunrise to relative planetary orbit, is computed from the site you pick
          here.
        </Text>
  ...
  return (
    <View className="flex-row items-center gap-3">
      <Pressable onPress={onPress} className="flex-1 flex-row items-center gap-3 py-1">
        <Icon name={active ? "check" : "mapPin"} size={20} color={active ? Palette.white : Palette.iconSubtle} />
